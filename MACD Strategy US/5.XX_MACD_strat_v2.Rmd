...
macd_strategy = function(dat_i) {
  ...
  for (m in macd_entry) {
    ...
    #price_entry = (macd12_26_9$signal[m-1] - 11/13*ema12[m-1] + 25/27*ema26[m-1])*351/28
    
    price_entry = 351/28*(    macd12_26_9$MACD[m-1]                               - 11/13*ema12[m-1] + 25/27*ema26[m-1])
    #price_entry = 351/28*(1/5*macd12_26_9$MACD[m-1] + 4/5*macd12_26_9$signal[m-2] - 11/13*ema12[m-1] + 25/27*ema26[m-1])
    #price_entry = 351/28*(    macd12_26_9$signal[m-1]                             - 11/13*ema12[m-1] + 25/27*ema26[m-1])
    
    #print((price_entry1 - price_entry)/price_entry*100)
