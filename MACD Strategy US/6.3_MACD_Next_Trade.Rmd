...
# # 
# - add the stop loss order using previous day's high, repeat everyday until position closes
# -----------------------------------------------------------------------------------------------
...
for (i in 1:length(stocks$Symbol)) {
  ...
  price_entry = 351/28*(macd12_26_9$MACD[m] - 11/13*ema12[m] + 25/27*ema26[m])
...
stocks_enter = stocks_enter[,c("Symbol","exchange","Cap","Float","price.entry","stop.loss","stop.per")]
