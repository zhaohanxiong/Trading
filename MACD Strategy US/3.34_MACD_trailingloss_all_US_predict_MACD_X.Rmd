...
# - ~40% of trades actually have MACD cross, the crossed trades have ~80% win, the non-crossed have ~40% win
...
trade_hist1 = trade_hist1[trade_hist1$ticker %in% stocks$Symbol[stocks$Cap>2000],]
