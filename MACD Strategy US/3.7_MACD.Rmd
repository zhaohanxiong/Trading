...
p[[2]] = sprintf(" Win Streak: %i",       max(rle$lengths[rle$values==1.5],na.rm=TRUE))
p[[3]] = sprintf("Lose Streak: %i",       max(rle$lengths[rle$values==-1],na.rm=TRUE))
